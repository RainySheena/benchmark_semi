...
new_labels <- read.csv('./labels/randomly_wrong_human_immune_30_obs.csv', row.names = 1)
...
write.csv(pca_embeddings_ordered, file = "./embeddings/human_immune_stacas_embeddings_randomly_wrong_30.csv", row.names = TRUE)
```
