...
new_labels <- read.csv('../labels/randomly_wrong_lung_atlas_70_obs.csv', row.names = 1)
```
...
write.csv(pca_embeddings_ordered, file = "../embeddings/lung_atlas_stacas_embeddings_randomly_wrong_70.csv", row.names = TRUE)
```
