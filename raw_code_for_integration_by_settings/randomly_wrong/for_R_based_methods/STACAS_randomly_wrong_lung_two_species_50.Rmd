...
```{r}
new_labels <- read.csv('./labels/randomly_wrong_lung_two_species_50_obs.csv', row.names = 1)
...
write.csv(pca_embeddings_ordered, file = "./embeddings/lung_two_species_stacas_embeddings_randomly_wrong_50.csv", row.names = TRUE)
```
