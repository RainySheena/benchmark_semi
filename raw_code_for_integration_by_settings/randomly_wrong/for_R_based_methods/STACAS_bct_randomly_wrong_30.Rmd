...
hard_label <- read.csv('./labels/wrong_label_bct_30.csv', row.names = 1)

# Add the new labels to the Seurat object's metadata
object@meta.data$hard_label <- hard_label$wrong_label
```
...
write.csv(pca_embeddings_ordered, file = "./embeddings/bct_stacas_embeddings_randomly_wrong_labels_30.csv", row.names = TRUE)
```
