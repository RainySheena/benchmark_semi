...
# Load the new labels CSV file
new_labels <- read.csv('./labels/randomly_wrong_macaque_70_obs.csv', row.names = 1)
...
write.csv(pca_embeddings_ordered, file = "./embeddings/macaque_stacas_embeddings_randomly_wrong_70.csv", row.names = TRUE)
```
