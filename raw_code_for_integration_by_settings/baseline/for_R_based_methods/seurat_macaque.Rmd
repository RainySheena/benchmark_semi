...
object <- IntegrateLayers(
  object = object, method = RPCAIntegration,
  new.reduction = "integrated.rpca", normalization.method = "SCT",
  k.anchor = 10, # Change k.anchor to a larger value
  verbose = FALSE
)
```
...
write.csv(pca_embeddings_ordered, file = "./embeddings/macaque_seurat_embeddings.csv", row.names = TRUE)
```