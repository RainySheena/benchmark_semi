...
object_integrated_ss <- obj.list %>%
  Run.STACAS(dims = 1:ndim, anchor.features = nfeatures, cell.labels = "cell_type", label.confidence = 0.5)
...
write.csv(pca_embeddings_ordered, file = "./lung_atlas_stacas_embeddings_full_annotated.csv", row.names = TRUE)
```
