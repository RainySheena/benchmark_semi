...
object_integrated_ss <- obj.list %>%
  Run.STACAS(dims = 1:ndim, anchor.features = nfeatures, cell.labels = "celltype", label.confidence = 0.5)
...
write.csv(pca_embeddings_ordered, file = "./embeddings/lung_two_species_stacas_embeddings_full_labels.csv", row.names = TRUE)
```
