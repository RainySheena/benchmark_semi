...
predict_labels <- read.csv('./azimuth_human_immune_predict_labels.csv')

# Add the new labels to the Seurat object's metadata
object@meta.data$predict_labels <- predict_labels$x
```
...
write.csv(pca_embeddings_ordered, file = "./human_immune_stacas_azimuth.csv", row.names = TRUE)
```
