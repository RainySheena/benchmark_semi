...
write_csv(predict_labels_df, "./singleR_human_immune_predict_labels.csv")
```

```{r}
predict_labels <- read.csv('./singleR_human_immune_predict_labels.csv')
...
write.csv(pca_embeddings_ordered, file = "./human_immune_stacas_singleR.csv", row.names = TRUE)
```
