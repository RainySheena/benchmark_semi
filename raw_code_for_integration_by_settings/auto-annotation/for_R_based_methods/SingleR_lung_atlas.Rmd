...
write_csv(predict_labels_df, "./singleR_lung_atlas_predict_labels.csv")
```

```{r}
predict_labels <- read.csv('./singleR_lung_atlas_predict_labels.csv')
...
write.csv(pca_embeddings_ordered, file = "./lung_atlas_stacas_singleR.csv", row.names = TRUE)
```
