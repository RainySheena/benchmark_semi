...
# Increase the timeout value for Azimuth ref download
...
write.csv(azimuth_prediction, file = "./labels/azimuth_labels_lung_two_species.csv", row.names = FALSE)
```


```{r}
# Load the hard labels CSV file
predict_labels <- read.csv('./labels/azimuth_labels_lung_two_species.csv', row.names = 1)
...
write.csv(pca_embeddings_ordered, file = "./embeddings/lung_two_species_stacas_embeddings_azimuth.csv", row.names = TRUE)
```
