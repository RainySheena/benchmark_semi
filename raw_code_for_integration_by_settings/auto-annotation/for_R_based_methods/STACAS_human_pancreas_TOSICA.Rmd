...
```{r}
predict_labels <- read.csv('./labels/TOSICA_label_human_pancreas_obs.csv')
...
write.csv(pca_embeddings_ordered, file = "./embeddings/human_pancreas_stacas_embeddings_tosica.csv", row.names = TRUE)
```
