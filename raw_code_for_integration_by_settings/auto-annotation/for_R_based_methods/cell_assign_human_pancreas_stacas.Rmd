...
predict_labels <- read.csv('./human_pancreas_cellassign_predictions.csv')
...
write.csv(pca_embeddings_ordered, file = "./human_pancreas_stacas_embeddings_cell_assign.csv", row.names = TRUE)
```
