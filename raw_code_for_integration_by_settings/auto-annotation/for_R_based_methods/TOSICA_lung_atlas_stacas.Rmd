...
predict_labels <- read.csv('../labels/TOSICA_label_lung_atlas_obs.csv', row.names = 1)

# Add the new labels to the Seurat object's metadata
object@meta.data$predict_labels <- as.factor(predict_labels$tosica_labels)
```
...
write.csv(pca_embeddings_ordered, file = "../embeddings/lung_atlas_stacas_tosica.csv", row.names = TRUE)
```
