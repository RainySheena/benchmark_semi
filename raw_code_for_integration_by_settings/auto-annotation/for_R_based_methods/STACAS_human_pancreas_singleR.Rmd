...
# Convert("../human_pancreas_norm_processed.h5ad", dest = "h5seurat", overwrite = TRUE)
...
write_csv(predict_labels_df, "./singleR_human_pancreas_predict_labels.csv")
```

```{r}
predict_labels <- read.csv('./labels/singleR_human_pancreas_predict_labels.csv')
...
write.csv(pca_embeddings_ordered, file = "./embeddings/human_pancreas_stacas_embeddings_singleR.csv", row.names = TRUE)
```
