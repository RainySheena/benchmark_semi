...
predict_labels <- read.csv('./human_immune_cellassign_predictions.csv')
...
write.csv(pca_embeddings_ordered, file = "./human_immune_stacas_embeddings_cell_assign.csv", row.names = TRUE)
```
