...
batch_labels <- read.csv('./labels/batch_labels_macaque_70.csv', row.names = 1)
```
...
object[["nFeature_RNA"]] <- Matrix::colSums(GetAssayData(object, layer = "counts") > 0)
...
write.csv(pca_embeddings_ordered, file = "./embeddings/macaque_stacas_embeddings_partially_annotated_batches_70.csv", row.names = TRUE)
```
