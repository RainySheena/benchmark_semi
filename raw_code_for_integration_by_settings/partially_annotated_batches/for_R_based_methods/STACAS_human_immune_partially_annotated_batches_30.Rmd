...
batch_labels <- read.csv('./batch_labels_human_immune_30.csv', row.names = 1)
```
...
write.csv(pca_embeddings_ordered, file = "./human_immune_stacas_embeddings_partially_annotated_batches_30.csv", row.names = TRUE)
```
