...
batch_labels <- read.csv('./labels/batch_labels_macaque_50.csv', row.names = 1)
```
...
write.csv(pca_embeddings_ordered, file = "./embeddings/macaque_stacas_embeddings_partially_annotated_batches_50.csv", row.names = TRUE)
```
