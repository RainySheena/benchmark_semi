...
batch_labels <- read.csv('./batch_labels_lung_atlas_30.csv', row.names = 1)
```
...
write.csv(pca_embeddings_ordered, file = "./lung_atlas_stacas_embeddings_partially_annotated_batches_30.csv", row.names = TRUE)
```
