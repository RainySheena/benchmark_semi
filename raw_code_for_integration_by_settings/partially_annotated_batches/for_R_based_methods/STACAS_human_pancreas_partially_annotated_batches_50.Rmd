...
batch_labels <- read.csv('./batch_labels_human_pancreas_50.csv', row.names = 1)
```
...
write.csv(pca_embeddings_ordered, file = "./human_pancreas_stacas_embeddings_partially_annotated_batches_50.csv", row.names = TRUE)
```
