...
hard_label <- read.csv('./hard_label_lung_atlas_30.csv', row.names = 1)
```
...
write.csv(pca_embeddings_ordered, file = "./lung_atlas_stacas_embeddings_randomly_missing_labels_30.csv", row.names = TRUE)
```
