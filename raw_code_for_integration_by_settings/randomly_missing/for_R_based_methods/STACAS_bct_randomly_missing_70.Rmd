...
hard_label <- read.csv('./labels/hard_label_bct_70.csv', row.names = 1)
...
write.csv(pca_embeddings_ordered, file = "./embeddings/bct_stacas_embeddings_randomly_missing_labels_70.csv", row.names = TRUE)
```
