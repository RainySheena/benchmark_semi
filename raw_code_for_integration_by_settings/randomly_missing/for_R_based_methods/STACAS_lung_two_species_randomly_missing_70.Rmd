...
hard_label <- read.csv('./labels/hard_label_lung_two_species_70.csv', row.names = 1)
```
...
write.csv(pca_embeddings_ordered, file = "./embeddings/lung_two_species_stacas_embeddings_randomly_missing_labels_70.csv", row.names = TRUE)
```
