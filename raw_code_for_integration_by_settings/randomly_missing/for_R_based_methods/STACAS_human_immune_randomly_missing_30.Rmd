...
hard_label <- read.csv('./hard_label_human_immune_30.csv', row.names = 1)
```
...
write.csv(pca_embeddings_ordered, file = "./human_immune_stacas_embeddings_randomly_missing_labels_30.csv", row.names = TRUE)
```
