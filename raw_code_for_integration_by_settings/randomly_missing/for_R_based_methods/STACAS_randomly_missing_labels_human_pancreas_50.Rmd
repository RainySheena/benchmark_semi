...
hard_label <- read.csv('./hard_label_human_pancreas_50.csv', row.names = 1)
...
write.csv(pca_embeddings_ordered, file = "./human_pancreas_stacas_embeddings_randomly_missing_50.csv", row.names = TRUE)
```
