...
hard_label <- read.csv('./hard_label_human_immune_70.csv', row.names = 1)
```
...
write.csv(pca_embeddings_ordered, file = "./human_immune_stacas_embeddings_randomly_missing_labels_70", row.names = TRUE)
```
