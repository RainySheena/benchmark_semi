...
```{r}
new_labels <- read.csv('./labels/missing_and_mixing_at_edge_lung_two_species_70_obs.csv', row.names = 1)
```
...
write.csv(pca_embeddings_ordered, file = "./embeddings/lung_two_species_stacas_embeddings_missing_and_mixing_at_edge_70.csv", row.names = TRUE)
```
