...
new_labels <- read.csv('../labels/missing_and_mixing_at_edge_lung_atlas_30_obs.csv', row.names = 1)
```
...
write.csv(pca_embeddings_ordered, file = "../embeddings/lung_atlas_stacas_embeddings_missing_and_mixing_at_edge_30.csv", row.names = TRUE)
```
