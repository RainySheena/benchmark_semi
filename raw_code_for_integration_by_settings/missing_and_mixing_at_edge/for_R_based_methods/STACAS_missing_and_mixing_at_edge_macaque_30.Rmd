...
new_labels <- read.csv('./labels/missing_and_mixing_at_edge_macaque_30_obs.csv', row.names = 1)
...
original_cell_order <- colnames(object[["RNA"]]@layers[["counts"]])
...
write.csv(pca_embeddings_ordered, file = "./embeddings/macaque_stacas_embeddings_missing_and_mixing_at_edge_30.csv", row.names = TRUE)
```
