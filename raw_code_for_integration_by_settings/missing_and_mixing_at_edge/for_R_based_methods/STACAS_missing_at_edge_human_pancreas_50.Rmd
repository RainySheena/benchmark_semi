...
new_labels <- read.csv('./new_labels_50_human_pancreas.csv', row.names = 1)
...
write.csv(pca_embeddings_ordered, file = "./human_pancreas_stacas_embeddings_mixing_at_edge_50.csv", row.names = TRUE)
```
