...
new_labels <- read.csv('./labels/missing_and_mixing_at_edge_human_immune_30_obs.csv', row.names = 1)
```
...
write.csv(pca_embeddings_ordered, file = "./embeddings/human_immune_stacas_embeddings_missing_and_mixing_at_edge_30.csv", row.names = TRUE)
```
