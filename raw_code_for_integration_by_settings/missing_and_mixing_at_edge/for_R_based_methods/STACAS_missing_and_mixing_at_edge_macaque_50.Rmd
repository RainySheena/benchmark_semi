...
new_labels <- read.csv('./labels/missing_and_mixing_at_edge_macaque_50_obs.csv', row.names = 1)
...
write.csv(pca_embeddings_ordered, file = "./embeddings/macaque_stacas_embeddings_missing_and_mixing_at_edge_50.csv", row.names = TRUE)
```
