...
new_labels <- read.csv('./new_labels_30_human_pancreas.csv', row.names = 1)
...
write.csv(pca_embeddings_ordered, file = "./human_pancreas_stacas_embeddings_mixing_at_edge_30.csv", row.names = TRUE)
```
